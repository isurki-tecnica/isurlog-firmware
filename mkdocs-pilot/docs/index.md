...
!!! note "Migration in progress"
    Use and Hardware, Firmware Development, and Data Integration & APIs (Modules A, B, and C) have fully moved here. Troubleshooting is still on the **[GitHub Wiki](https://github.com/isurki-tecnica/isurlog-firmware/wiki)** for now, and will move here too.
