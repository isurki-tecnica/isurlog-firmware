...
!!! note "Migration in progress"
    Use and Hardware and Firmware Development (Modules A and B) have fully moved here. Data Integration & APIs and Troubleshooting are still on the **[GitHub Wiki](https://github.com/isurki-tecnica/isurlog-firmware/wiki)** for now, and will move here too.
...
| **Start here:** [2. Sensor Connections](sensor-connections.md) | **Start here:** [1. Build Environment Setup](build-environment.md) | **Start here:** [9. Data Access Overview ↗](https://github.com/isurki-tecnica/isurlog-firmware/wiki/9-Data-Access-Overview) |
