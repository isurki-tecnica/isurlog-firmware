...
| Column | Description |
| :--- | :--- |
| **ID del tag** | The unique identifier of the tag. |
| **Tag** | The descriptive name of the tag. |
| **Grupo de usuario** | The group to which the tag belongs. |
...
1.  **Select Tag:** The user must click on the desired tag in the list. This opens the tag's management screen, where its **Descripción** can be edited and saved.
