...
class AnalogInput:
    def __init__(self, sda_pin=None, scl_pin=None, i2c_freq=None, ads1115_addr=None):
        ...
        # Load configuration from config.json, or use defaults if not provided.
        ...
        self.ads1115_addr = ads1115_addr if ads1115_addr is not None else config_manager.static_config.get("ads1115_addr", 0x48)
